...
TEST_PLATFORMS = {
    ...
    "Rev7 MacOSX Yosemite 10.10.5 DevEdition": {"run": {"machine": {"os": "yosemite 10.10"}}, "build": {"platform": "macosx64"}},
    ...
    "Windows 7 32-bit DevEdition": {"run": {"machine": {"os": "win7"}}, "build": {"platform": "win32"}},
    "Windows 7 VM 32-bit": {"run": {"machine": {"os": "win7"}}, "build": {"platform": "win32"}},
    "Windows 7 VM 32-bit DevEdition":  {"run": {"machine": {"os": "win7"}}, "build": {"platform": "win32"}},
    "Windows 7 VM-GFX 32-bit": {"run": {"machine": {"os": "win7"}, "type":["gfx"]}, "build": {"platform": "win32"}},
    "Windows 7 VM-GFX 32-bit DevEdition": {"run": {"machine": {"os": "win7"}, "type":["gfx"]}, "build": {"platform": "win32"}},
    "Windows 8 64-bit": {"run": {"machine": {"os": "win8"}}, "build": {"platform": "win64"}},
    "Windows 8 64-bit DevEdition": {"run": {"machine": {"os": "win8"}}, "build": {"platform": "win64"}},
...
KNOWN_PLATFORM = {
    ...
    "macosx64-devedition":  {"build": {"platform": "macosx64"}},
    ...
    "win32-devedition": {"build": {"platform": "win32", "type": ["debug"]}},
    ...
    "win64-devedition":  {"build": {"platform": "win64"}},
    ...
    "win8_64_devedition": {"run": {"machine": {"os": "win8"}}, "build": {"platform": "win64"}},
