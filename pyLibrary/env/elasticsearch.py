...
class Index(object):
    ...
    def threaded_queue(self, batch_size=None, max_size=None, period=None):
        return ThreadedQueue("elasticsearch: " + self.settings.index, self, batch_size=batch_size, max_size=max_size, period=period)
