...
`format()` function with more formatting features and to replace the 
Perl-inspired line noise (formatting mini language)[https://docs.python.org/2/library/string.html#formatspec] 
